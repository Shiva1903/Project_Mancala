...
def minimax_ab(game, depth, player_id, maximizing_player, alpha, beta):
    ...
    if not valid_moves:
        ...
        return minimax_ab(game, depth - 1, 1 - player_id, maximizing_player, alpha, beta)
    ...
    if player_id == maximizing_player:
        ...
        for move in valid_moves:
            ...
            eval_score, _ = minimax_ab(new_game, depth - 1, 1 - player_id, maximizing_player, alpha, beta)
...
def ai_move(game, ai_player_id, depth=6):
    _, best_move = minimax_ab(game, depth, ai_player_id, ai_player_id, float('-inf'), float('inf'))
    return best_move
